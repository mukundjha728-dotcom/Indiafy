  ...
  useEffect(() => {
    ...
    const interval = setInterval(() => {
      if (scrollContainerRef.current) {
        ...
        const scrollAmount = cardElement ? cardElement.clientWidth + 16 : 300; // 16px is gap-4
  ...
  return (
    <section className="py-24 bg-white overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        ...
        {/* Negative margin on mobile to allow cards to bleed to the edge of screen */}
          ...
          >
            {trendingProducts.map((product, index) => (
              <motion.div
                ...
                viewport={{ once: true }}
                // Yahan w-[280px] fix kar diya hai mobile ke liye taaki dusra card dikhe
