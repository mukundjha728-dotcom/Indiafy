            ...
            <div className="bg-zinc-900 border border-zinc-800 rounded-[2.5rem] p-8 shadow-xl">
              ...
              <div className="grid md:grid-cols-2 gap-4">
                {initialAddresses.map((addr) => (
                  <div
                    key={addr.id}
                    className={`p-6 rounded-3xl border-2 transition-all cursor-pointer ${addr.default ? "border-zinc-700 bg-zinc-950/50" : "border-zinc-800 hover:border-zinc-700 bg-zinc-950/20"}`}
                  >
