      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
        <div>
          ...
          <div className="flex flex-wrap items-center gap-3">
            ...
            <span className="px-2.5 py-1 rounded-md text-xs font-bold bg-slate-900 text-white tracking-wider">ORD-199</span>
          </div>
        </div>
      ...
      <div className="flex flex-col lg:flex-row gap-6">
        ...
        <div className="flex-1 flex flex-col bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden">
          ...
          <div className="px-5 py-4 bg-slate-50 border-b border-slate-100">
            <div className="flex items-start gap-4">
              ...
              <div>
                <h3 className="font-bold text-sm text-slate-900">Amit Kumar</h3>
                <p className="text-xs font-medium text-slate-500 mt-0.5 leading-relaxed">Sector 23, House 402, Chandigarh</p>
              </div>
            </div>
          </div>
        ...
        <div className="flex-1 flex flex-col gap-6">
          ...
          <div className="flex flex-col gap-4">
            ...
            >
              {allVerified && videoSrc ? <CheckCircle size={20} /> : <Lock size={20} />}
