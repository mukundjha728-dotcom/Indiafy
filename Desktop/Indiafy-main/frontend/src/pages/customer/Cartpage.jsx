                  ...
                  {cartItems.map((item) => (
                    ...
                    >
                      <div className="flex flex-col sm:flex-row gap-6">
                        ...
                        >
                          <img
                            src={item.productId?.images?.[0] || "https://placehold.co/400x400?text=No+Image"}
                  ...
                  <div className="space-y-3">
                    {saved.map((item) => (
                      ...
                      >
                        ...
                        >
                          <img src={item.productId?.images?.[0] || "https://placehold.co/400x400?text=No+Image"} className="w-full h-full object-cover" alt={item.productId?.name} />
                        </div>
