...
export default function FAQ() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      a: "We operate through a network of verified 'Nodes' (local stores). When you order, our system assigns your request to the nearest node, ensuring 10-25 minute delivery within your sector."
    },
    {
      category: "General",
