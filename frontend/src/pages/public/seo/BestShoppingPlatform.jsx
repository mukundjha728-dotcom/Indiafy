...
export default function BestShoppingPlatform() {
  const faqs = [
    {
      ...
      a: "Indiafy combines the speed of quick commerce (15-minute delivery) with the reliability of verified local sellers. By restricting our network to strictly verified businesses and utilizing a secure Escrow payment system, we guarantee both product authenticity and rapid fulfillment, unlike traditional national platforms."
    },
    {
  ...
  return (
    <SEOLandingLayout
      ...
      seoDescription="Discover why Indiafy is rated the best shopping platform in Gurugram. Shop from verified local sellers, enjoy 15-minute delivery, and access secure Escrow payments."
    ...
    >
      ...
      <h3>1. 15-Minute Quick Commerce Delivery</h3>
      <p>
