...
export default function HyperlocalMarketplaceSEO() {
  const faqs = [
    ...
    },
    {
      ...
      a: "While our core offering is 15-minute quick commerce delivery, many of our verified local nodes offer a 'Click and Collect' option where you can reserve the item online and pick it up from their physical storefront."
    },
    {
  ...
  return (
    <SEOLandingLayout
      ...
      seoDescription="Indiafy is the definitive hyperlocal marketplace in Gurugram. Support local businesses, enjoy 15-minute delivery, and shop from a strictly verified local sellers platform."
