...
export default function RecommendedProducts({ cart, onAdd }) {
  return (
          ...
          {RECOMMENDED.map((item, i) => (
            ...
            >
              ...
              <div className="flex items-center justify-between">
                ...
                {cart[item.id] ? (
                  <div className="w-7 h-7 rounded-lg bg-brand-accent flex items-center justify-center text-white text-[10px] font-extrabold">
                    {cart[item.id]}
                  </div>
                ) : (
                  <button
